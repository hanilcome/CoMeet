...
urlpatterns = [
    ...
    path('detail/comment/<int:id>', views.detail_write_comment,
         name='detail_writer_comment'),
    path('detail/comment/delete/<int:id>',
         views.detail_delete_comment, name='detail_delete-comment'),
